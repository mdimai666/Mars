...
Статус на 2026-09-15: ревизия сделана, **этапы 1–5 выполнены** (коммиты `313fb04e`, `0068b272`,
`02757a32`, `15e7a327`, `5e5d6f4d` и `b43632ef` — доводка верстки/редактора). Сделаны вторая итерация
визуала грида (этап 5.1) и фиксы по итогам проверки в браузере (этап 5.2) — **не закоммичены**.
Этап 6 (не-SQL провайдеры) не начат; визуал проверяет пользователь в браузере.
