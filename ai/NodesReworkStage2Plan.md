...
> Рецепты ниже частично перенесены в действующий гайд [NodeCreationGuide.md](./NodeCreationGuide.md)
> (разделы «Значения полей» и «Контракты выходов»); при закрытии инициативы сверить остаток с ним.
