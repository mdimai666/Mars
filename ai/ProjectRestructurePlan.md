...
Открытые хвосты: ~~`UserService.cs` — закомментированная строка со старым `SysOption`~~ — ✅ убрана (2026-08-30).
