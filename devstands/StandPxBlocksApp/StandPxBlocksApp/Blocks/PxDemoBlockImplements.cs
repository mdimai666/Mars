...
{
    public string TypeId => "demostand.demo.number";
...
{
    public string TypeId => "demostand.demo.string";
...
{
    public string TypeId => "demostand.demo.any";
...
{
    public string TypeId => "demostand.demo.object";
...
public sealed class PxDemoCreateObjectImplement : IPxExpressionImplement
{
    ...
    public string TypeId => "demostand.demo.create_object";
