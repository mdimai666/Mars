...
namespace Mars.Data.PostgreSQL.Migrations {
    ...
    [Migration("20260821205615_FamilyMetaValueTables")]
    partial class FamilyMetaValueTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Mars.Data.Entities.PostCategoryTypeMetaFieldEntity", b =>
                {
                    b.Property<Guid>("PostCategoryTypeId")
                        .HasColumnType("uuid")
                        .HasColumnName("post_category_type_id");
                    ...
                    b.HasKey("PostCategoryTypeId", "MetaFieldId")
                        .HasName("pk_post_category_type_meta_fields");

                    b.HasIndex("MetaFieldId")
                        .HasDatabaseName("ix_post_category_type_meta_fields_meta_field_id");

                    b.ToTable("post_category_type_meta_fields", (string)null);
                });
            ...
            modelBuilder.Entity("Mars.Data.Entities.PostTypeMetaFieldEntity", b =>
                {
                    b.Property<Guid>("PostTypeId")
                        .HasColumnType("uuid")
                        .HasColumnName("post_type_id");
            ...
            modelBuilder.Entity("Mars.Data.Entities.UserTypeMetaFieldEntity", b =>
                {
                    b.Property<Guid>("UserTypeId")
                        .HasColumnType("uuid")
                        .HasColumnName("user_type_id");
            ...
            modelBuilder.Entity("Mars.Data.Entities.PostCategoryTypeMetaFieldEntity", b =>
                {
                    b.HasOne("Mars.Data.Entities.MetaFieldEntity", "MetaField")
                        .WithMany("PostCategoryTypeMetaFields")
                        .HasForeignKey("MetaFieldId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_post_category_type_meta_fields_meta_fields_meta_field_id");
                    ...
                    b.HasOne("Mars.Data.Entities.PostCategoryTypeEntity", "PostCategoryType")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_post_category_type_meta_fields_post_category_types_post_cat");
            ...
            modelBuilder.Entity("Mars.Data.Entities.MetaFieldEntity", b =>
                {
                    ...
                    b.Navigation("PostCategoryTypeMetaFields");
