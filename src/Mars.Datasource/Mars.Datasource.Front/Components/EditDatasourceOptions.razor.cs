...
/// <summary>
/// Форма списка источников: карточка на источник, выбор типа и движка; поля конкретного типа
/// (REST, файлы) вынесены в свои компоненты.
/// </summary>
public partial class EditDatasourceOptions
{
    ...
    static bool IsFileKind(string kind) => string.Equals(kind, DatasourceKind.File, StringComparison.OrdinalIgnoreCase);

    static bool IsRestKind(string kind) => string.Equals(kind, DatasourceKind.Rest, StringComparison.OrdinalIgnoreCase);
