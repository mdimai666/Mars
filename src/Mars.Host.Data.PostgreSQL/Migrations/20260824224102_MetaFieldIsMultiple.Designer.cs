...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Mars.Host.Data.Entities.MediaFolderEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Mars.Host.Data.Entities.MetaSequenceEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Mars.Host.Data.Entities.PostCategoryEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Mars.Host.Data.Entities.PostCategoryMetaValueEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Mars.Host.Data.Entities.PostCategoryTypeEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Mars.Host.Data.Entities.PostPostCategoriesEntity", b =>
                {
                    b.Property<Guid>("PostId")
                        .HasColumnType("uuid")
                        .HasColumnName("post_id");
            ...
            modelBuilder.Entity("Mars.Host.Data.Entities.FileEntity", b =>
                {
                    b.HasOne("Mars.Host.Data.Entities.MediaFolderEntity", "Folder")
                        .WithMany("Files")
            ...
            modelBuilder.Entity("Mars.Host.Data.Entities.MediaFolderEntity", b =>
                {
                    b.HasOne("Mars.Host.Data.Entities.MediaFolderEntity", "Parent")
                        .WithMany("Children")
            ...
            modelBuilder.Entity("Mars.Host.Data.Entities.MetaFieldEntity", b =>
                {
                    b.HasOne("Mars.Host.Data.Entities.PostCategoryTypeEntity", "PostCategoryType")
                        .WithMany("MetaFields")
                    ...
                    b.OwnsOne("Mars.Host.Data.OwnedTypes.MetaFields.MetaFieldDefaultValue", "Default", b1 =>
                        {
            ...
            modelBuilder.Entity("Mars.Host.Data.Entities.PostCategoryEntity", b =>
                {
                    b.HasOne("Mars.Host.Data.Entities.PostCategoryEntity", "Parent")
                        .WithMany()
                        .HasForeignKey("ParentId")
                    ...
                    b.HasOne("Mars.Host.Data.Entities.PostCategoryEntity", "Root")
                        .WithMany()
            ...
            modelBuilder.Entity("Mars.Host.Data.Entities.PostCategoryMetaValueEntity", b =>
                {
                    ...
                    b.HasOne("Mars.Host.Data.Entities.PostCategoryEntity", "PostCategory")
                        .WithMany("MetaValues")
