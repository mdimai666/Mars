...
/// администратор типа в параметрах системных полей (<c>post_types.Options["systemFields"]</c>) —
/// по умолчанию уникальность slug не требуется (существующие записи могли создаваться без неё).
/// </summary>
