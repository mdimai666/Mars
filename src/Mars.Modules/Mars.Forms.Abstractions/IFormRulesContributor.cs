...
/// чистые и считаются <see cref="Mars.Forms.Contracts.FormRuleEvaluator"/>. Реализация регистрируется
/// синглтоном в модуле провайдера и применяется при создании <see cref="IFormRuleRegistry"/>,
/// поэтому правила провайдера доступны в любом хосте и в тестах, собирающих контейнер.
/// </summary>
