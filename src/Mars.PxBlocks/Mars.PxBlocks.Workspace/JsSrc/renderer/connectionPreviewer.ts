// Ported from microsoft/pxt (MIT): pxtblocks/plugins/renderer/connectionPreviewer.ts
import * as Blockly from "blockly";

export class ConnectionPreviewer extends Blockly.InsertionMarkerPreviewer {
    static CONNECTION_INDICATOR_RADIUS = 9;

    protected connectionLine: SVGLineElement | null = null;
    protected draggedConnectionIndicator: SVGElement | null = null;
    protected staticConnection: Blockly.RenderedConnection | null = null;
    protected staticConnectionIndicator: SVGElement | null = null;
    ...
    private showDraggedIndicatorWithLine(draggedConn: Blockly.RenderedConnection, staticConn: Blockly.RenderedConnection) {
        if (!this.connectionLine) {
            this.connectionLine = Blockly.utils.dom.createSvgElement<SVGLineElement>(
                'line',
                {
    ...
    private raiseIndicators() {
        ...
        if (this.draggedConnectionIndicator) {
        ...
        if (staticParent && this.staticConnectionIndicator) {
