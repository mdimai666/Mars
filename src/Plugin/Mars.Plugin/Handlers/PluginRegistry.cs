...
/// дата установки, отключён. Читается и пишется через IFileStorage до/после Build.
/// </summary>
internal class PluginRegistry
{
    ...
    public void MarkInstalled(string packageId, PluginSource source, string version, DateTimeOffset installedAtUtc)
    {
