...
namespace Mars.Data.PostgreSQL.Migrations {
    ...
    [Migration("20241206203428_AddNavMenuAndFeedbacks")]
    partial class AddNavMenuAndFeedbacks
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Mars.Data.Entities.FeedbackEntity", b =>
                {
                    ...
                    b.Property<int>("FeedbackType")
                        ...
                        .HasComment("РўРёРї РѕР±СЂР°С‚РЅРѕР№ СЃРІСЏР·Рё");

                    b.Property<string>("FilledUsername")
                        .HasMaxLength(256)
                        .HasColumnType("varchar(256)")
                        .HasColumnName("filled_username")
                        .HasComment("Р—Р°РїРѕР»РЅРµРЅРЅРѕРµ РёРјСЏ");
                    ...
                    b.ToTable("feedbacks", null, t =>
                        {
                            t.HasComment("РћР±СЂР°С‚РЅР°СЏ СЃРІСЏР·СЊ");
                        });
                });
            ...
            modelBuilder.Entity("Mars.Data.Entities.FileEntity", b =>
                {
                    ...
                    b.Property<string>("FileExt")
                        ...
                        .HasComment("Р Р°СЃС€РёСЂРµРЅРёРµ С„Р°Р№Р»Р°. Р‘РµР· РІРµРґСѓС‰РµР№ С‚РѕС‡РєРё.");

                    b.Property<string>("FileName")
                        .IsRequired()
                        .HasColumnType("varchar(256)")
                        .HasColumnName("file_name")
                        .HasComment("РРјСЏ С„Р°Р№Р»Р°");
                    ...
                    b.Property<string>("FilePhysicalPath")
                        ...
                        .HasComment("Р¤РёР·РёС‡РµСЃРєРёР№ РїСѓС‚СЊ С„Р°Р№Р»Р° РѕС‚ upload");

                    b.Property<decimal>("FileSize")
                        .HasColumnType("numeric(20,0)")
                        .HasColumnName("file_size")
                        .HasComment("Р Р°Р·РјРµСЂ С„Р°Р№Р»Р° РІ Р±Р°Р№С‚Р°С…");
                    ...
                    b.Property<string>("FileVirtualPath")
                        ...
                        .HasComment("Р’РёСЂС‚СѓР°Р»СЊРЅС‹Р№ РїСѓС‚СЊ С„Р°Р№Р»Р°");

                    b.Property<FileEntityMeta>("Meta")
                        .IsRequired()
                        .HasColumnType("jsonb")
                        .HasColumnName("meta")
                        .HasComment("РњРµС‚Р° РїРѕР»СЏ");
            ...
            modelBuilder.Entity("Mars.Data.Entities.MetaFieldEntity", b =>
                {
                    ...
                    b.Property<string>("Description")
                        ...
                        .HasComment("РћРїРёСЃР°РЅРёРµ");

                    b.Property<bool>("Disabled")
                        .HasColumnType("boolean")
                        .HasColumnName("disabled")
                        .HasComment("РћС‚РєР»СЋС‡РµРЅ");

                    b.Property<bool>("Hidden")
                        .HasColumnType("boolean")
                        .HasColumnName("hidden")
                        .HasComment("РЎРєСЂС‹С‚РѕРµ");
                    ...
                    b.Property<decimal?>("MaxValue")
                        ...
                        .HasComment("РњР°РєСЃРёРјР°Р»СЊРЅРѕРµ");

                    b.Property<decimal?>("MinValue")
                        .HasColumnType("numeric")
                        .HasColumnName("min_value")
                        .HasComment("РњРёРЅРёРјР°Р»СЊРЅРѕРµ");

                    b.Property<string>("ModelName")
                        .HasMaxLength(128)
                        .HasColumnType("varchar(128)")
                        .HasColumnName("model_name")
                        .HasComment("РњРѕРґРµР»СЊ");
                    ...
                    b.Property<int>("Order")
                        .HasColumnType("integer")
                        .HasColumnName("order")
                        .HasComment("РџРѕСЂСЏРґРѕРє");

                    b.Property<Guid>("ParentId")
                        .HasColumnType("uuid")
                        .HasColumnName("parent_id")
                        .HasComment("Р РѕРґРёС‚РµР»СЊСЃРєРѕРµ РјРµС‚Р° РїРѕР»Рµ");
            ...
            modelBuilder.Entity("Mars.Data.Entities.NavMenuEntity", b =>
                {
                    ...
                    b.Property<bool>("RolesInverse")
                        ...
                        .HasComment("РќРµ РґР»СЏ СЂРѕР»РµР№");
            ...
            modelBuilder.Entity("Mars.Data.Entities.PostEntity", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("DeletedAt")
                        ...
                        .HasComment("РЈРґР°Р»РµРЅ РІ");

                    b.Property<string>("Excerpt")
                        .HasMaxLength(512)
                        .HasColumnType("text")
                        .HasColumnName("excerpt")
                        .HasComment("РћС‚СЂС‹РІРѕРє");
            ...
            modelBuilder.Entity("Mars.Data.Entities.PostTypeEntity", b =>
                {
                    ...
                    b.HasAlternateKey("TypeName")
                        .HasName("ak_post_types_type_name");
            ...
            modelBuilder.Entity("Mars.Data.Entities.UserEntity", b =>
                {
                    ...
                    b.Property<DateTime>("BirthDate")
                        ...
                        .HasComment("Р”РµРЅСЊ СЂРѕР¶РґРµРЅРёСЏ");
            ...
            modelBuilder.Entity("Mars.Data.Entities.UserMetaFieldEntity", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uuid")
                        .HasColumnName("user_id");
            ...
            modelBuilder.Entity("Mars.Data.Entities.PostEntity", b =>
                {
                    b.HasOne("Mars.Data.Entities.PostTypeEntity", "PostType")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_posts_post_types_type");
            ...
            modelBuilder.Entity("Mars.Data.Entities.RoleClaimEntity", b =>
                {
                    b.HasOne("Mars.Data.Entities.RoleEntity", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Mars.Data.Entities.UserClaimEntity", b =>
                {
                    b.HasOne("Mars.Data.Entities.UserEntity", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
