...
namespace Mars.Data.PostgreSQL.Migrations {
    ...
    [Migration("20260821194152_MetaValuesCleanup")]
    partial class MetaValuesCleanup
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Mars.Data.Entities.MetaValueEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("MetaFieldId", "StringShort")
                        .HasDatabaseName("ix_meta_values_meta_field_id_string_short");
            ...
            modelBuilder.Entity("Mars.Data.Entities.PostCategoryMetaValueEntity", b =>
                {
                    ...
                    b.HasKey("PostCategoryId", "MetaValueId")
                        .HasName("pk_post_category_meta_values");

                    b.HasIndex("MetaValueId")
                        .HasDatabaseName("ix_post_category_meta_values_meta_value_id");
            ...
            modelBuilder.Entity("Mars.Data.Entities.PostCategoryMetaValueEntity", b =>
                {
                    b.HasOne("Mars.Data.Entities.MetaValueEntity", "MetaValue")
                        .WithMany("PostCategoryMetaValues")
                        .HasForeignKey("MetaValueId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_post_category_meta_values_meta_values_meta_value_id");
