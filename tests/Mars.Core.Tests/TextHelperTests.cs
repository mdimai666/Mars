...
public class TextHelperTests
{
    ...
    [Fact]
    public void SplitArguments_QuotedAndTupleGroups_KeepsGroupsIntact()
    {
    ...
    [Fact]
    public void SplitArguments_MenuItemsWithNestedBrackets_KeepsGroupsIntact()
    {
        string input = "Home, Edit, HDMI (4K, ARC), Test, Double 2.0 x1, Multi (F1, (f2-f5, f6, 58), FF, o2), ARG";
        string[] expect = new string[]
        {
            "Home",
            "Edit",
    ...
    public void IsValidSlug_MixedValidAndInvalidStrings_ClassifiesCorrectly()
    {
        ...
        string[] notValid = [null!, "", "-post", ".post.", "пост", "a__!@#$%^&*()+=__z", "(z)"];
        ...
        foreach (string val in notValid)
        {
