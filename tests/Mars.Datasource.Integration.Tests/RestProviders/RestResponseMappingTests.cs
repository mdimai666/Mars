...
public class RestResponseMappingTests
{
    ...
    public void Map_InfersColumnTypes()
    {
        ...
        result.Columns.Select(column => column.DataTypeName).Should()
    ...
    public void Map_NestedValueIsJsonColumn()
    {
        ...
        var title = result.Columns.Single(column => column.Name == "title");
    ...
    public void Map_MissingValueIsNull()
    {
        ...
        result.Columns.Select(column => column.Name).Should().Equal("id", "x");
    ...
    public void Map_ArrayOfValuesBecomesSingleColumn()
    {
        ...
        result.Columns.Select(column => column.Name).Should().Equal("value");
    ...
    public void Map_NonJsonBodyBecomesResponseCell()
    {
        ...
        result.Ok.Should().BeTrue();
        result.Columns.Select(column => column.Name).Should().Equal("response");
