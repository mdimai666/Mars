...
public class RestRequestBuilderTests
{
    ...
    [Fact]
    public void Settings_AuthIsReadFromJsonSetting()
    {
        var settings = RestSourceSettings.From(new DatasourceConfig
        {
            Kind = DatasourceKind.Rest,
            ...
            {
                [DatasourceSettings.BaseUrl] = "https://example.org",
                [DatasourceSettings.Auth] = """{"mode":"BasicAuth","username":"admin","password":"secret"}""",
            },
        });
    ...
    [Fact]
    public void Settings_BrokenAuthJsonMeansNoAuth()
    {
        var settings = RestSourceSettings.From(new DatasourceConfig
        {
            Kind = DatasourceKind.Rest,
            Slug = "wp",
            Settings = new Dictionary<string, string> { [DatasourceSettings.Auth] = "{ mode:" },
        });
    ...
    [Fact]
    public void Settings_WithoutAuthSettingHasNoAuth()
    {
