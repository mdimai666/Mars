...
public class WordPressRestDiscoveryTests
{
    ...
    public void Build_RouteRegexBecomesPathParameter()
    {
        ...
        var id = Object(groups, "GET /wp-json/wp/v2/posts/{id}").Operation!.Parameters.Single(parameter => parameter.Name == "id");
    ...
    public void Build_ReadArgsAreQueryParameters()
    {
        ...
        var parameters = Object(groups, "GET /wp-json/wp/v2/posts").Operation!.Parameters;
    ...
    public void Build_WriteArgsAreBodyParameters()
    {
        ...
        var parameters = Object(groups, "POST /wp-json/wp/v2/posts").Operation!.Parameters;
    ...
    public void Build_OperationCarriesHttpDraftWithRealPath()
    {
        ...
        operation.Fields.Should().BeEmpty();
    }
